  ...
  return (
    <>
      <section className="dark:bg-black dark:text-gray-100">
        <div className="container flex flex-col justify-center p-6 mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-between">
          <div className="flex flex-col justify-center p-6 text-center rounded-sm lg:max-w-md xl:max-w-lg lg:text-left">
            <h1 className="animate__animated animate__fadeInLeft text-5xl font-bold w-full leadi sm:text-6xl">
              Hii! Its Me <span className="sachin"> Sachin. </span>
            </h1>
            <h3 className="animate__animated animate__fadeInLeft mt-6 mb-8 font-semibold text-2xl">
            ...
            <div className="flex flex-col space-y-4 sm:items-center sm:justify-center sm:flex-row sm:space-y-0 sm:space-x-4 lg:justify-start">
              <a
                ...
                target="_blank"
                href={Resume}
                className="resumebtn animate__animated animate__fadeIn px-8 py-3 text-lg font-semibold rounded  dark:text-white"
              >
                Resume
              </a>
            </div>
      ...
      <div className="about bg-black flex flex-row">
        <div className="left m-10 w-3/6 h-auto">
          <img data-aos="fade-up" src={Sleep} className=" w-full h-auto" alt="" />
        </div>
